...
public class Tusuarioamigo implements java.io.Serializable {
    ...
    public Tusuarioamigo(String codigoUsuarioAmigo, Tusuario tusuario, String nombre, String apellidoPaterno, String apellidoMaterno, String correoElectronico, String contrasenia, Date fechaNacimiento, boolean sexo, String telefono, Date fechaRegistro, Date fechaModificacion, Set tactividadparticipantes, Set tusuarioamigotelefonos, Set tactividadcomentarios) {
        this.codigoUsuarioAmigo = codigoUsuarioAmigo;
        this.tusuario = tusuario;
        this.nombre = nombre;
        this.apellidoPaterno = apellidoPaterno;
