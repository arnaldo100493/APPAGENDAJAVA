...
public class SessionURLFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response) throws IOException, ServletException {
        if (debug) {
            log("SessionURLFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response) throws IOException, ServletException {
        if (debug) {
            log("SessionURLFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
        ...
        String[] arrayUrlsPermitidasSinSesion = new String[]{"faces/index.xhtml", "faces/usuario/registrar.xhtml"};
        ...
        if (session.getAttribute("correoElectronico") == null) {
            ...
            for (String item : arrayUrlsPermitidasSinSesion) {
