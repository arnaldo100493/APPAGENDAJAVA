...
--
-- Table structure for table `tunidadmedida`
--

DROP TABLE IF EXISTS `tunidadmedida`;
...
--
-- Dumping data for table `tunidadmedida`
--

LOCK TABLES `tunidadmedida` WRITE;
/*!40000 ALTER TABLE `tunidadmedida` DISABLE KEYS */;
/*!40000 ALTER TABLE `tunidadmedida` ENABLE KEYS */;
UNLOCK TABLES;
